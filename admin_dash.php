...
if (!isset($_SESSION['username'])) {
    header("Location: index.html"); // Redirect to home or login page if not logged in
    exit();
}
...
<script>
    ...
    if (dashboardLink) {
        dashboardLink.href = "admin_dash.php"; // Redirect to the correct admin dashboard page (admin_dash.php)
    }
